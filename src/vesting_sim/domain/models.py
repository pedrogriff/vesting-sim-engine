...
class GrantType(StrEnum):
    ...
    GSU = "RSU"  # Backwards-compatible alias for Restricted Stock Unit


class ScheduleType(StrEnum):
    """Standard corporate equity vesting schedules."""

    FRONT_LOADED_33_33_22_12 = "FRONT_LOADED_33_33_22_12"  # Front-loaded enterprise schedule
...
class EquityGrant:
    ...
    employee_id: str
    total_shares: int
    grant_type: GrantType = GrantType.RSU
